...
def upstreamProjects = [
  ...
  'taglib', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-file-taglib</artifactId>

  // Runtime Direct
  'renderer-html', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-file-renderer-html</artifactId>
  'style', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-file-style</artifactId>
  'view', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-file-view</artifactId>
