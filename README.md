...
[![Build](https://github.com/ao-apps/semanticcms-file-all/actions/workflows/build.yml/badge.svg?branch=master)](https://github.com/ao-apps/semanticcms-file-all/actions?query=workflow%3ABuild)
